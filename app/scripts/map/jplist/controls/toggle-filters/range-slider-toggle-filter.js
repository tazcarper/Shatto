(function($){
	...
	*/
	jQuery.fn.jplist.controls.RangeSliderToggleFilter.render = function(control){
        ...
        prev = control.$control.attr('data-min');
        next = control.$control.attr('data-max');
        ...
        if(prev && $.isNumeric(prev)){
            control.$control.data('prev', prev);
        }

        if(next && $.isNumeric(next)){
            control.$control.data('next', next);
        }
	};
	...
	* @memberOf jQuery.fn.jplist.controls.RangeSliderToggleFilter
	*/
	jQuery.fn.jplist.controls.RangeSliderToggleFilter.getDeepLink = function(control){
	...
	* @memberOf jQuery.fn.jplist.controls.RangeSliderToggleFilter
	*/
	jQuery.fn.jplist.controls.RangeSliderToggleFilter.getStatusByDeepLink = function(control, propName, propValue){
		return null;
	};
	...
	* @memberOf jQuery.fn.jplist.controls.RangeSliderToggleFilter
	*/
	jQuery.fn.jplist.controls.RangeSliderToggleFilter.getPaths = function(control, paths){
	...
	* @memberOf jQuery.fn.jplist.controls.RangeSliderToggleFilter
	*/
	jQuery.fn.jplist.controls.RangeSliderToggleFilter.getStatus = function(isDefault, control){
        ...
        prev = control.$control.data('prev');
        next = control.$control.data('next');
	...
	* @memberOf jQuery.fn.jplist.controls.RangeSliderToggleFilter
	*/
	jQuery.fn.jplist.controls.RangeSliderToggleFilter.setStatus = function(status, control, isCookie){
	...
	* @memberOf jQuery.fn.jplist.controls.RangeSliderToggleFilter
	*/
	jQuery.fn.jplist.controls.RangeSliderToggleFilter.initEvents = function(control){
