    ...
    $.fn.dateDropper = function(options) {
        return $(this).each(function() {
            if ($(this).is('input') && $(this).attr('type') == "text") {
                ...
                var
                    _dd_init = function() {
                        ...
                        _dd.find('.dd-d li').each(function(index, element) {
                            ...
                            if (_d == 0 || _d == 1) $(this).addClass('dd-sun');
                ...
                // SHS added to open date dropper on field focus
                // this is to support using tab to fill form
                _dd_input.bind('focusin', function(e){
                  e.preventDefault();
