...
(function(library) {
    ...
    $(function() {
        ...
        window.addEventListener("scroll", function(e) {
            ...
            maxHeight = $(window).height() - $(window).height() * .15;
            halfHeight = maxHeight * .5;
            ...
            if ($(".parallax")[0]) {
                $(".parallax").each(function() {
                    var yPos = ($(window).scrollTop() - $(this).offset().top) / $(this).data("speed"), coords = "50% " + yPos + "px";
                    $(this).css({
        ...
        // homepage scripts
        if ($("#floatingBottle")[0]) {
            var theH = 0, floatingBottle = $("#floatingBottle");
            var bottleWidth = $("#floatingBottle img").width(), theBottle = $("#floatingBottle"), bottles = 16, arrayIndex = 8, // Custom rotation order
            customRotation = [ 9, 10, 11, 12, 13, 14, 15, 16, 1, 2, 3, 4, 5, 6, 7, 8, 9 ], screenWidth, bottlesArray = Array.apply(null, {
                length: bottles
