          ...
          <div data-type="panel">
            <div data-type="controls" class="controls">
              <div class="findInput">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/dist/images/map-mobile-pin.png" data-src="<?php echo get_template_directory_uri(); ?>/dist/images/map-mobile-pin.png" data-src-retina="<?php echo get_template_directory_uri(); ?>/dist/images/map-mobile-pin_2x.png" alt="Search Location" >
                </div>
