    ...
    $.fn.dateDropper = function (options) {
        return $(this).each(function () {
            if ($(this).is('input') && $(this).attr('type') == "text") {
                ...
                var _dd_input = $(this),
                    _dd = $('#dd-w-' + _dd_id),
                    _dd_isB = function _dd_isB(y) {
                    return !(y % 4 || !(y % 100) && y % 400);
                },
                    _dd_0 = function _dd_0(n) {
                    return n < 10 ? '0' + n : n;
                },
                    _dd_settings = $.extend({
                ...
                var _dd_color = function _dd_color(col, amt) {
                ...
                var _dd_c_invert = function _dd_c_invert(hexTripletColor) {
                ...
                switch (_dd_settings.lang) {
                    ...
                    //Arabic
                    case 'ar':
                        var mn = ["جانفي", "فيفري", "مارس", "أفريل", "ماي", "جوان", "جويلية", "أوت", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"];
                        var dn = ['الأحد', 'الإثنين', 'الثلثاء', 'الأربعاء', 'الخميس', 'الجمعة', 'السبت'];
                        break;
                    //italian
                    case 'it':
                        var mn = ["Gennaio", "Febbraio", "Marzo", "Aprile", "Maggio", "Giugno", "Luglio", "Agosto", "Settembre", "Ottobre", "Novembre", "Dicembre"];
                        var dn = ['Domenica', 'Lunedì', 'Martedì', 'Mercoledì', 'Giovedì', 'Venerdì', 'Sabato'];
                        break;
                    //hungarian	
                    case 'hu':
                        var mn = ["január", "február", "március", "április", "május", "június", "július", "augusztus", "szeptember", "október", "november", "december"];
                        var dn = ['vasárnap', 'hétfő', 'kedd', 'szerda', 'csütörtök', 'péntek', 'szombat'];
                        break;
                    //greek
                    case 'gr':
                        var mn = ["Ιανουάριος", "Φεβρουάριος", "Μάρτιος", "Απρίλιος", "Μάιος", "Ιούνιος", "Ιούλιος", "Αύγουστος", "Σεπτέμβριος", "Οκτώβριος", "Νοέμβριος", "Δεκέμβριος"];
                        var dn = ['Κυριακή', 'Δευτέρα', 'Τρίτη', 'Τετάρτη', 'Πέμπτη', 'Παρασκευή', 'Σάββατο'];
                        break;
                    //espanol
                    case 'es':
                    ...
                    //dansk
                    case 'da':
                        var mn = ["januar", "februar", "marts", "april", "maj", "juni", "juli", "august", "september", "oktober", "november", "december"];
                    ...
                    case 'pt':
                        ...
                        var dn = ["Domingo", "Segunda", "Terça", "Quarta", "Quinta", "Sexta", "Sábado"];
                        break;
                    //slovenian
                    case 'si':
                        var mn = ["januar", "februar", "marec", "april", "maj", "junij", "julij", "avgust", "september", "oktober", "november", "december"];
                        var dn = ['nedelja', 'ponedeljek', 'torek', 'sreda', 'četrtek', 'petek', 'sobota'];
                        break;
                    //ukrainian
                    case 'uk':
                        var mn = ["січень", "лютий", "березень", "квітень", "травень", "червень", "липень", "серпень", "вересень", "жовтень", "листопад", "грудень"];
                        var dn = ['неділя', 'понеділок', 'вівторок', 'середа', 'четвер', 'п\'ятниця', 'субота'];
                        break;
                    //russian
                    case 'ru':
                    ...
                    case 'tr':
                        ...
                        var dn = ['Pazar', 'Pazartesi', 'Sali', 'Çarşamba', 'Perşembe', 'Cuma', 'Cumartesi'];
                        break;
                    //korean	
                    case 'ko':
                        var mn = ["1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"];
                        var dn = ['일요일', '월요일', '화요일', '수요일', '목요일', '금요일', '토요일'];
                        break;
                    //finnish
                    case 'fi':
                        var mn = ["Tammikuu", "Helmikuu", "Maaliskuu", "Huhtikuu", "Toukokuu", "Kesäkuu", "Heinäkuu", "Elokuu", "Syyskuu", "Lokakuu", "Marraskuu", "Joulukuu"];
                        var dn = ['Sunnuntai', 'Maanantai', 'Tiistai', 'Keskiviikko', 'Torstai', 'Perjantai', 'Lauantai'];
                        break;
                    //english	
                    default:
                ...
                var _dd_init = function _dd_init() {
                    ...
                    _dd.find('.dd-d li').each(function (index, element) {
                        ...
                        if (_d == 0 || _d == 1) $(this).addClass('dd-sun');else $(this).removeClass('dd-sun');
                    ...
                    _dd_placement = function _dd_placement() {
                    ...
                    */
                    ...
                    if (Modernizr.mq('(min-width: 900px)')) {
                        _dd.find('.dd-c').css({
                            'top': _dd_input.offset().top - _dd_settings.dropHeight / 2 + 25,
                            'left': _dd_input.offset().left + (_dd_input.innerWidth() + 25)
                    ...
                    _dd_submit = function _dd_submit() {
                    console.log('submit');
                    if (_dd_settings.lock) {

                        var d1 = Date.parse(t_y_cur + "-" + (t_m_cur + 1) + "-" + t_d_cur) / 1000,
                    ...
                    console.log(x);
                    if (x == 0 || x == 1) {
                        alert('We do not provide tours on Sunday or Monday. Please select another date.');
                        return;
                    }
                    var str = _dd_settings.format.replace(/\b(d)\b/g, _dd_0(_dd_d)).replace(/\b(m)\b/g, _dd_0(_dd_m)).replace(/\b(Y)\b/g, _dd_y).replace(/\b(D)\b/g, dn[x].substr(0, 3)).replace(/\b(l)\b/g, dn[x]).replace(/\b(F)\b/g, mn[_dd_m - 1]).replace(/\b(M)\b/g, mn[_dd_m - 1].substr(0, 3)).replace(/\b(n)\b/g, _dd_m).replace(/\b(j)\b/g, _dd_d);

                    _dd_input.val(str);

                    _dd.find('.dd-c').addClass('dd-fadeout').removeClass('dd-' + _dd_settings.init_animation);
                    ...
                    _dd_calculate = function _dd_calculate(y) {
                    ...
                    _dd_construct = function _dd_construct() {
                    ...
                    _dd.find('.dd-s-b').each(function (index, element) {
                        ...
                        if (_dd_el.hasClass('dd-s-b-m') || _dd_el.hasClass('dd-s-b-d')) {
                            ...
                            if (_dd_el.hasClass('dd-s-b-m')) {
                                ...
                                for (var i = i_min; i < i_max; i++) {
                                    ...
                                    _dd_el.find('ul').append('<li data-id="' + (i + 1) + '">' + mn[i].substr(0, 3) + '<span>' + _dd_0(i + 1) + '</span></li>');
                                }
                            }
                            if (_dd_el.hasClass('dd-s-b-d')) {
                                ...
                                for (var i = i_min; i < i_max; i++) {
                                    ...
                                    _dd_el.find('ul').append('<li data-id="' + (i + 1) + '">' + _dd_0(i + 1) + '<span></span></li>');
                                }
                            }
                        }
                        ...
                        if (_dd_el.hasClass('dd-s-b-y')) {
                            ...
                            for (var i = _dd_settings.minYear; i <= _dd_settings.maxYear; i++) {
                                if (i % _dd_settings.yearsRange == 0) _dd_el.find('ul').append('<li data-id="' + i + '">' + i + '</li>');
                            }
                        }
                        ...
                        _dd_el.on('mousewheel DOMMouseScroll', function (e) {
                            ...
                            if (e.originalEvent.wheelDeltaY < 0 || e.originalEvent.detail > 0) top = _dd_el.scrollTop() + 100;
                    ...
                    _dd.find('.dd-b').each(function (index, element) {
                        ...
                        if (_dd_el.hasClass('dd-m')) {
                            ...
                            _dd_el.find('li').click(function () {
                                if (_dd_settings.format == 'm' || _dd_settings.format == 'n' || _dd_settings.format == 'F' || _dd_settings.format == 'M') return false;
                        ...
                        _dd_el.find('.dd-n').click(function () {
                            ...
                            if ($(this).hasClass('dd-n-left')) {
                                ...
                                if (__dd_el.length && __dd_el.is(":visible")) y = parseInt(__dd_el.attr('data-id'));else y = parseInt(_dd_el.find('li:visible:last').attr('data-id'));
                            } else {

                                __dd_el = _dd_el.find('li[data-id="' + x + '"]').next('li');

                                if (__dd_el.length && __dd_el.is(":visible")) y = parseInt(__dd_el.attr('data-id'));else y = parseInt(_dd_el.find('li:first').attr('data-id'));
                            }
                    ...
                    _dd.find('.dd-b li').click(function () {
                        ...
                        if (_dd_settings.format == 'm' || _dd_settings.format == 'n' || _dd_settings.format == 'F' || _dd_settings.format == 'M' || _dd_settings.format == 'Y') return false;
                    ...
                    if (_dd.hasClass('dd-init')) {
                        ...
                        if (parseInt(_dd_input.attr('data-d')) && parseInt(_dd_input.attr('data-d')) <= 31) _dd_d = parseInt(_dd_input.attr('data-d'));

                        if (parseInt(_dd_input.attr('data-m')) && parseInt(_dd_input.attr('data-m')) <= 11) _dd_m = parseInt(_dd_input.attr('data-m')) + 1;

                        if (parseInt(_dd_input.attr('data-y')) && _dd_input.attr('data-y').length == 4) _dd_y = parseInt(_dd_input.attr('data-y'));
...
//# sourceMappingURL=datedropper.js.map
