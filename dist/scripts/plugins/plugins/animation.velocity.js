...
(function (root, factory) {
...
})(undefined, function (ScrollMagic, velocity) {
	"use strict";
	...
	ScrollMagic.Scene.extend(function () {
		...
		var animate = function animate(elem, properties, options) {
		...
		var reverse = function reverse(elem, options) {
			if (_util.type.Array(elem)) {
				elem.forEach(function (elem) {
   ...
   * @private
   */
		var updateAnimationProgress = function updateAnimationProgress() {
			if (_elems) {
