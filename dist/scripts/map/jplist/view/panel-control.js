 ...
 */
	var getDeepLink = function getDeepLink(self) {
 ...
 */
	var getStatusByDeepLink = function getStatusByDeepLink(self, propName, propValue) {
 ...
 */
	var getPaths = function getPaths(self) {
 ...
 * @return {jQuery.fn.jplist.models.Status}
 */
	var getStatus = function getStatus(self, isDefault) {
 ...
 */
	var setStatus = function setStatus(self, status, isCookie) {

		var setStatus;

		if (status.action === self.action && status.name === self.name) {
 ...
 * @constructor 
 */
	var Init = function Init($jplistBox, options, $control, events) {
