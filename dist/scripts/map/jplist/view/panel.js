 ...
 */
	...
	var getPanelControls = function getPanelControls(self, $controls) {
 ...
 */
	var setDeepLinks = function setDeepLinks(self, params, controls) {
 ...
 */
	var getParamsFromDeepLinkUrl = function getParamsFromDeepLinkUrl(self, hash) {
 ...
 * @return {string} url
 */
	var getDeepLinksUrl = function getDeepLinksUrl(self, controls) {
 ...
 */
	var setStickyPosition = function setStickyPosition($stickyEl) {
 ...
 */
	var initSticky = function initSticky(self, $sticky) {
 ...
 * @constructor 
 */
	var Init = function Init($jplistBox, options, events) {
