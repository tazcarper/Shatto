 ...
 * @function
 */
	jQuery.fn.jplist.controls.DefaultSort.statusRelatedDataSort = function (dataPath, type, order, dateTimeFormat, ignore) {
 ...
 */
	jQuery.fn.jplist.controls.DefaultSort.getPaths = function (control, paths) {

		var jqPath, dataType, path;
 ...
 */
	jQuery.fn.jplist.controls.DefaultSort.getStatus = function (isDefault, control) {
		...
		data = new jQuery.fn.jplist.controls.DefaultSort.statusRelatedDataSort(control.$control.attr('data-path'), control.$control.attr('data-type'), control.$control.attr('data-order'), control.$control.attr('data-datetime-format'), control.$control.attr('data-ignore'));
