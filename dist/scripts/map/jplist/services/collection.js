 ...
 */
	...
	var dataviewToString = function dataviewToString(self) {
 ...
 * @return {jQueryObject}
 */
	var dataviewToJqueryObject = function dataviewToJqueryObject(self) {
 ...
 * @return {jQueryObject}
 */
	var dataitemsToJqueryObject = function dataitemsToJqueryObject(self) {
 ...
 */
	var modifyDataview = function modifyDataview(self, callback) {
 ...
 * @param {Object} self - jplist collection 'this' object
 */
	var resetDataview = function resetDataview(self) {
 ...
 */
	var indexOf = function indexOf(self, item) {
 ...
 */
	var delDataitem = function delDataitem(self, $item) {
 ...
 */
	var delDataitems = function delDataitems(self, items) {
 ...
 * @param {number} index
 */
	var addDataItem = function addDataItem(self, item, paths, index) {
 ...
 * @param {Array.<jQuery.fn.jplist.models.Path>} paths - paths objects array
 */
	var addDataItems = function addDataItems(self, items, paths) {
