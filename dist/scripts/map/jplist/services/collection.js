'use strict';/*global jQuery:false */(function($){'use strict';/**
	...
	* @return {string}
	*/var dataviewToString=function dataviewToString(self){var dataitem,html="",i;for(i=0;i<self.dataview.length;i++){//get dataitem
dataitem=self.dataview[i];//add dataitem html
html+=dataitem.html;}return html;};/**
	* convert dataview to jquery object
	* @return {jQueryObject}
	*/var dataviewToJqueryObject=function dataviewToJqueryObject(self){return $(self.dataview).map(function(index,$element){return $element.jqElement.get();});};/**
	* convert dataitems to jquery object
	* @return {jQueryObject}
	*/var dataitemsToJqueryObject=function dataitemsToJqueryObject(self){return $(self.dataitems).map(function(index,$element){return $element.jqElement.get();});};/**
	* modify dataview (sort, filter etc.)
	* @param {Object} self - jplist collection 'this' object
	* @param {Function} callback
	*/var modifyDataview=function modifyDataview(self,callback){if($.isFunction(callback)){callback(self.dataview);}};/**
	* reset dataview: dataview <- dataitems
	* @param {Object} self - jplist collection 'this' object
	*/var resetDataview=function resetDataview(self){self.dataview=$.merge([],self.dataitems);};/**
	...
	*/var indexOf=function indexOf(self,item){var dataitem,index=-1,html1,html2;for(var i=0;i<self.dataitems.length;i++){//get dataitem
dataitem=self.dataitems[i];//get outer html
html1=jQuery.fn.jplist.services.Helper.getOuterHtml(dataitem.jqElement);html2=jQuery.fn.jplist.services.Helper.getOuterHtml(item);if(html1===html2){//dataitem.jqElement.is(item)	
index=i;break;}}return index;};/**
	* delete dataitem from dataitems array
	* @param {Object} self - jplist collection 'this' object	
	* @param {jQueryObject} $item - jquery element to delete
	*/var delDataitem=function delDataitem(self,$item){var index;index=indexOf(self,$item);if(index!==-1){self.dataitems.splice(index,1);//trigger del item event
self.$jplistBox.trigger(self.options.del_item_event,[$item,self.dataitems]);}};/**
	...
	*/var delDataitems=function delDataitems(self,items){items.each(function(){delDataitem(self,$(this));});};/**
	* add jquery item to jplist dataitems array
	* @param {Object} self - jplist collection 'this' object
	* @param {jQueryObject} item - item to add to dataitems array
	* @param {Array.<jQuery.fn.jplist.models.Path>} paths - paths objects array
	* @param {number} index
	*/var addDataItem=function addDataItem(self,item,paths,index){var dataItem;//create dataitem
dataItem=new jQuery.fn.jplist.models.Dataitem(item,paths,index);//add item dataitems to array
self.dataitems.push(dataItem);//trigger add item event
self.$jplistBox.trigger(self.options.add_item_event,[dataItem,self.dataitems]);};/**
	...
	* @param {Array.<jQuery.fn.jplist.models.Path>} paths - paths objects array
	*/var addDataItems=function addDataItems(self,items,paths){items.each(function(index){addDataItem(self,$(this),paths,index);});};/**
	* empty collection
	* @param {Object} self - jplist collection 'this' object	
	*/var empty=function empty(self){self.dataitems=[];self.dataview=[];};/** 
	* jplist collection constructor
    * @param {jQueryObject} $jplistBox - jplist jquery element
	* @param {Object} options - jplist user options
	* @return {Object} - jplist collection
	* @constructor 
	*/var Init=function Init($jplistBox,options){var self={dataitems:[],dataview:[],$jplistBox:$jplistBox,options:options};return $.extend(this,self);};//api -----------------------------------------------------------------
/**
	...
	* @function
	*/Init.prototype.dataviewToJqueryObject=function(){return dataviewToJqueryObject(this);};/**
	...
	* @function
	*/Init.prototype.dataitemsToJqueryObject=function(){return dataitemsToJqueryObject(this);};/**
	* API: reset dataview collection with initial dataitems set.
	* @public	
	* @memberOf jQuery.fn.jplist.services.Collection#
	* @name resetDataview
	* @function
	*/Init.prototype.resetDataview=function(){resetDataview(this);};/**
	...
	* @name modifyDataview
	* @function
	*/Init.prototype.modifyDataview=function(callback){modifyDataview(this,callback);};/**
	* API: empty collection
	* @public	
	* @memberOf jQuery.fn.jplist.services.Collection#
	* @name empty
	* @function
	*/Init.prototype.empty=function(){empty(this);};/**
	...
	* @name addDataItem
	* @function
	*/Init.prototype.addDataItem=function(item,paths,index){addDataItem(this,item,paths,index);};/**
	...
	* @name addDataItems
	* @function
	*/Init.prototype.addDataItems=function(items,paths){addDataItems(this,items,paths);};/**
	...
	* @name delDataitem
	* @function
	*/Init.prototype.delDataitem=function(item){delDataitem(this,item);};/**
	...
	* @name delDataitems
	* @function
	*/Init.prototype.delDataitems=function(items){delDataitems(this,items);};/**
	...
	* @name indexOf
	* @function
	*/Init.prototype.indexOf=function(item){return indexOf(this,item);};/**
	...
	* @function
	*/Init.prototype.dataviewToString=function(){return dataviewToString(this);};/** 
	* jplist collection
    * @param {jQueryObject} $jplistBox - jplist jquery element
	* @param {Object} options - jplist user options
	* @constructor 
	...
	*/jQuery.fn.jplist.services.Collection=function($jplistBox,options){var self;//call constructor
