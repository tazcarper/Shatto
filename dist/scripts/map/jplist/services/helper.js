'use strict'; /*global jQuery:false */(function($){'use strict'; /** 
	...
	*/jQuery.fn.jplist.services.Helper.getOuterHtml=function(el){var html='';var attr=el[0].attributes;var inner=el.html();var name=el[0].tagName.toString().toLowerCase();html+='<'+name;for(var i=0;i<attr.length;i++){if(attr[i].nodeValue){html+=' '+attr[i].nodeName+'=';html+='"'+attr[i].nodeValue+'"';}}html+='>';html+=inner;html+='</'+name+'>';return html;}; /**
	* replace hash in url
	* @param {string} hash
