 ...
 */
	...
	var getItemsNumber = function getItemsNumber(itemsNumber) {
 ...
 * @return {number}
 */
	var getItemsOnPage = function getItemsOnPage(itemsOnPage, itemsNumber) {
 ...
 * @return {number}
 */
	var getPagesNumber = function getPagesNumber(itemsNumber, itemsOnPage) {
 ...
 * @return {number}
 */
	var getCurrentPage = function getCurrentPage(currentPage, pagesNumber) {
 ...
 * @return {number}
 */
	var getStart = function getStart(currentPage, itemsOnPage) {
 ...
 * @return {number}
 */
	var getEnd = function getEnd(start, itemsOnPage, itemsNumber) {
 ...
 * @return {number}
 */
	var getPrevPage = function getPrevPage(currentPage) {
 ...
 * @return {number}
 */
	var getNextPage = function getNextPage(currentPage, pagesNumber) {
