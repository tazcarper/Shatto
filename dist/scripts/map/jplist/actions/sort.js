 ...
 */
	var getDatetimeFormatItem = function getDatetimeFormatItem(replacedFormat, datetimeString) {
 ...
 * @return {number}
 */
	var formatTryParse = function formatTryParse(wilcard, value) {
 ...
 */
	var sortIndex = function sortIndex(dataitem1, dataitem2, order) {
 ...
 */
	var sortNumbers = function sortNumbers(dataitem1, dataitem2, order, path) {

		var pathitem1, pathitem2, number1, number2, result;
 ...
 */
	var sortText = function sortText(dataitem1, dataitem2, order, path, ignore) {

		var pathitem1, pathitem2, text1, text2, regexExpr;
 ...
 */
	var sortDatetime = function sortDatetime(dataitem1, dataitem2, order, path, dateTimeFormat) {

		var pathitem1, pathitem2, date1, date2;
 ...
 * @return {number} - -1, 0, 1
 */
	var doubleSort = function doubleSort(dataitem1, dataitem2, statuses, index) {
 ...
 */
	jQuery.fn.jplist.actions.Sort.formatDatetime = function (datetime, format) {
		...
		var formattedDatetime, replacedFormat, year, month, day, hour, minute, second;
