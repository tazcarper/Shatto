 ...
 */
	...
	var setDirections = function setDirections(self, start, end) {
 ...
 * @param {Object} self - this object
 */
	var closeAllInfoWindows = function closeAllInfoWindows(self) {
 ...
 * @param {Object} marker
 */
	var openInfoWindow = function openInfoWindow(self, marker) {
 ...
 * @param {Object} self - this object
 */
	var clearMarkers = function clearMarkers(self) {
 ...
 */
	var findMarker = function findMarker(self, store) {

		var marker, markerStore;
		...
		for (var i = 0; i < self.markers.length; i++) {
			...
			if (markerStore && markerStore.latitude === store.latitude && markerStore.longitude === store.longitude) {
 ...
 * @param {jQuery.fn.jlocator.store} store
 */
	var setMarker = function setMarker(self, store) {

		var infowindow, marker, markerSettings;
 ...
 */
	var setMarkers = function setMarkers(self, stores) {
 ...
 * @param {number} zoom
 */
	var setZoom = function setZoom(self, zoom) {
 ...
 * @param {number} zoom
 */
	var jump = function jump(self, latlng, zoom) {
 ...
 * @param {Object} self - this object
 */
	var initGeolocation = function initGeolocation(self) {
 ...
 */
	var initMap = function initMap(self, $mapRoot) {
