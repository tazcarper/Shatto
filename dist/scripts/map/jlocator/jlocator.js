 ...
 */
	...
	var Init = function Init(userOptions, $root) {
		...
		self.options = $.extend(true, {
			...
			, jplist: {
				...
				redraw_callback: function redraw_callback() {}
			...
			//info window content
			, infoWindow: function infoWindow(html, title, address, city, state, zipcode, country) {
