'use strict';(function($){'use strict'; /** 
	...
	*/jQuery.fn.jplist.controls.Autocomplete.render=function(control){var autocomplete,zoom,options={};if(control.controlTypeOptions){options=control.controlTypeOptions;} //init autocomplete
...
control.$control.data('jplist-autocomplete',autocomplete);control.$control.data('jplist-autocomplete-zoom',zoom);}; /**
	...
	* @param {jQuery.fn.jplist.view.PanelControl} control
	* @memberOf jQuery.fn.jplist.controls.Autocomplete
	*/jQuery.fn.jplist.controls.Autocomplete.initEvents=function(control){var autocomplete,listenerHandle=control.$control.data('jplist-handle'); //get autocomplete
...
control.$jplistBox.trigger(control.options.force_ask_event,[false]);console.log('auto complete done');$('.mapOverlay').addClass('shrink');});control.$control.off('keyup').on('keyup',function(e){var val; //get val
