...
(function (library) {
    ...
    $(function () {
        ...
        if ($("#floatingBottle")[0]) {
            ...
            var bottleWidth, theBottle, bottles, arrayIndex, customRotation, screenWidth, bottlesArray;
            var i;
            var waypoints;
            var stopWay;
            ...
            (function () {
                ...
                bottleWidth = $("#floatingBottle img").width();
                ...
                for (i = 2; i <= bottlesArray.length; i++) {
